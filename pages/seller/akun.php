          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings">Riwayat Penjualan</button>
                </li>
              </ul>
              <div class="tab-content pt-2">
                ...
                <h5 class="card-title">Profile Details</h5>
                    ...
                    <div class="col-lg-9 col-md-8">Budi</div>
                    </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="namaToko" type="text" class="form-control" id="fullName" value="Oxva">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="Budi">
                      </div>
                    </div>

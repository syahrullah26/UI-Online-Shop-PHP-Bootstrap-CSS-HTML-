        ...
        <div class="card mb-3">
            <div class="row g-0">
                ...
                <div class="col-md-2 mt-1 mb-3">
                    ...
                    <a href="index.php?page=tambah"><button class="btn btn-primary">Tambah Produk</button></a>
                </div>
            </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="index.php?page=edit"><button type="button" class="btn btn-primary">Edit</button></a><!-- get id pemesanan -->
